...
function M.setup()
    M.add({ event = "msg_history_show", renderer = "notify" })
    M.add({ event = "msg_show", renderer = "notify" })
    M.add({ event = { "msg_showmode", "msg_showcmd" }, renderer = "notify", })
    M.add({ event = "msg_show", kind = { "echoerr", "lua_error", "rpc_error", "emsg" }, renderer = "notify", })
    M.add({ event = "msg_show", kind = "wmsg", renderer = "notify", })
    vim.schedule(M.run)
end
